...
@section('header')
    <div class="flex items-center justify-between py-2">
        ...
        <a class="create-btn bg-green-500 text-white font-semibold py-1 px-2 hover:bg-green-600 rounded text-sm" href="{{ route('admin.users.create') }}">
                            ...
                            <tbody>
                                @foreach($users as $user)
                                    <tr class="bg-white border-t hover:bg-gray-50">
                                        <td>
                                            <a class="block py-4 px-6 text-sm text-gray-900 whitespace-nowrap" href="{{ route('admin.users.edit', $user->id) }}">
                                        ...
                                        <td>
                                            <a class="block py-4 px-6 text-sm text-gray-900 whitespace-nowrap text-center" href="{{ route('admin.users.edit', $user->id) }}">
                                                <span @class([
                                                    'px-2 inline-flex text-xs leading-5 font-semibold rounded-full capitalize',
                                                    'bg-blue-100 text-blue-800' => $user->isUser(),
                                                    'bg-orange-100 text-orange-800' => $user->isManager(),
                                        ...
                                        <td>
                                            <a class="block py-4 px-6 text-right" href="{{ route('admin.users.edit', $user->id) }}">
