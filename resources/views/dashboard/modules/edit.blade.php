        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form action="{{ route('dashboard.modules.update', $module->id) }}" method="POST">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div id="insert" class="grid grid-cols-6 gap-6" data-course="{{ old('course_id', $module->course_id) }}" data-part="{{ old('part', $module->part) }}" data-task="{{ old('task', $module->task) }}" data-description="{{ old('task', $module->description) }}"></div>
                        </div>
