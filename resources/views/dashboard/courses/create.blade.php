                                ...
                                <div class="col-span-6 space-y-2">
                                    @foreach($parts as $part)
                                        <div class="flex items-center">
                                            <input id="part-{{ $part->value }}" name="parts" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" value="{{ $part->value }}" @checked(old('parts', \App\Enums\Part::TwoParts->value) == $part->value)>
